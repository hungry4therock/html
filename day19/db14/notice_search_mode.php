...
<div id="wrap">
	...
	<div class="content">
		<form name="frm1" method="post" action="notice_search_ok.php">
		<table class="table1">
			<tr>
				<th>글번호</th>
				<th>글제목</th>
		...
		?>
			<tr><td colspan="5" align="center">
					...
					<input type="button" class="bt" value="검색하기" onclick="
					search()">
					<input type="button" class="bt" value="되돌아가기" onclick="
...
<script>
	...
	function search(){
		if(frm1.searchword.value==""){
			alert("검색어를 입력하여 주세요");
			frm1.searchword.focus();
			return false;
		}
